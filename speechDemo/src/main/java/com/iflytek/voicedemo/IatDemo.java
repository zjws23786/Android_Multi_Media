...
public class IatDemo extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		speechRecognizer = SpeechRecognizer.createRecognizer(IatDemo.this, mInitListener);
	...
	public void onClick(View view) {
		...
		case R.id.iat_recognize_stream:
			...
			// speechRecognizer.setParameter(SpeechConstant.ASR_SOURCE_PATH, "sdcard/XXX/XXX.pcm");
			ret = speechRecognizer.startListening(mRecognizerListener);
			if (ret != ErrorCode.SUCCESS) {
		...
		case R.id.iat_upload_userwords:
			...
			ret = speechRecognizer.updateLexicon("userword", contents, mLexiconListener);
			if (ret != ErrorCode.SUCCESS)
	...
	private ContactListener mContactListener = new ContactListener() {
		...
		public void onContactQueryFinish(final String contactInfos, boolean changeFlag) {
			...
			speechRecognizer.setParameter(SpeechConstant.ENGINE_TYPE,SpeechConstant.TYPE_CLOUD);
			speechRecognizer.setParameter(SpeechConstant.TEXT_ENCODING, "utf-8");
			ret = speechRecognizer.updateLexicon("contact", contactInfos, mLexiconListener);
			if (ret != ErrorCode.SUCCESS) {
				showTip("上传联系人失败：" + ret);
			}
		}
