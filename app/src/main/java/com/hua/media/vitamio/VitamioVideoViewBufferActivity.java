...
import com.hua.media.localvideo.SystemVideoPlayerActivity;
...
public class VitamioVideoViewBufferActivity extends BaseActivity implements View.OnClickListener {
    private RelativeLayout mVitamioVideoLayout;
    ...
    private SeekBar mVitamioVolumeSeek;
    private ImageView mVitamioChangeScreen;
    ...
    protected void setLayout() {
        ...
        setContentView(R.layout.activity_vitamio_video_view_buffer);
    }

    @Override
    protected void findViewById() {
        mVitamioVideoLayout = (RelativeLayout) findViewById(R.id.vitamio_videoLayout);
        ...
        mVitamioVolumeSeek = (SeekBar) findViewById(R.id.vitamio_volume_seek);
        mVitamioChangeScreen = (ImageView) findViewById(R.id.vitamio_change_screen);
    ...
    protected void setListener() {
        ...
        //屏幕改变按钮
        mVitamioChangeScreen.setOnClickListener(this);
        //切换了视频播放模式
        ...
        //音量进度条
        mVitamioVolumeSeek.setOnSeekBarChangeListener(new MyVolumeOnSeekBarChangeListener());
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.vitamio_pause_img:
                ...
                break;
            case R.id.vitamio_change_screen:
                if (isFullScreen){
                    //屏幕竖屏
    ...
    protected void init() {
        ...
        mVitamioVolumeSeek.setMax(maxVolume);
        mVitamioVolumeSeek.setProgress(currentVolume);
    ...
    private void playVideo() {
        //网络视频播放
        mVitamioVideoView.setVideoURI(Uri.parse(videoPath));
...
//            startVitamioPlayer();
            ...
            switch (extra){
                case MediaPlayer.MEDIA_ERROR_TIMED_OUT:
                    UIToast.showBaseToast(VitamioVideoViewBufferActivity.this,"超时",R.style.AnimationToast);
                    mVitamioProgressbarLayout.setVisibility(View.VISIBLE);
                    break;
                case MediaPlayer.MEDIA_ERROR_IO:
                    UIToast.showBaseToast(VitamioVideoViewBufferActivity.this,"IO",R.style.AnimationToast);
                    mVitamioProgressbarLayout.setVisibility(View.VISIBLE);
                    break;
                default:
                    break;
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE){
            ...
            mVitamioVideoView.setVideoSize(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
            ...
            mVitamioProgressbarLayout.setLayoutParams(progressbarLayoutParams);
            mVitamioVolumeSeek.setVisibility(View.VISIBLE);
            isFullScreen = true;
            ...
            mVitamioVideoView.setVideoSize(Env.screenWidth, DensityUtil.dip2px(this,240));
            progressbarLayoutParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                    DensityUtil.dip2px(this,190));
            mVitamioProgressbarLayout.setLayoutParams(progressbarLayoutParams);
            mVitamioVolumeSeek.setVisibility(View.GONE);
            isFullScreen = false;
    ...
    private void setVideoViewScale(int width , int height){
        ViewGroup.LayoutParams layoutParams = mVitamioVideoLayout.getLayoutParams();
        layoutParams.width = width;
        layoutParams.height = height;
        mVitamioVideoLayout.setLayoutParams(layoutParams);

        ViewGroup.LayoutParams layoutParams1 = mVitamioVideoLayout.getLayoutParams();
        layoutParams1.width = width;
        layoutParams1.height = height;
        mVitamioVideoLayout.setLayoutParams(layoutParams1);
    }
